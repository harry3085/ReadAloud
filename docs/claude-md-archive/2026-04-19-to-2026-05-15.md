# CLAUDE.md Archive — 2026-04-19 ~ 2026-05-15

이 파일은 CLAUDE.md 의 옛 세션 이력을 분리 보관한 아카이브입니다 (2026-05-23 분리).

원본 CLAUDE.md 에는 (1) 상단 고정 영역 (프로젝트 개요·배포·Firestore 컬렉션·관리자 앱 구조·주요 버그·작업 규칙 9개) 과 (2) 2026-05-16 이후 세션만 유지됩니다. 그 사이 옛 세션을 참조할 때 이 파일을 직접 Read 하세요.
